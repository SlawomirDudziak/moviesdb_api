...
class TVShowsController extends AbstractController
{
    ...
    public function upcoming_tvshows()
    {
        ...
        return $this->render('tvshows/upcoming_tvshows.html.twig', $tvshows);
    }
    ...
    public function top_rated_tvshows()
    {
        ...
        return $this->render('tvshows/top_rated_tvshows.html.twig', $tvshows);
    }
    ...
    {
        $tvshow = $this->fetch_tvshows($id);
        
        return $this->render('tvshows/tvshow_details.html.twig', array('details' => $tvshow));
    }
}
